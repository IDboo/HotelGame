    ...
    public partial class mig1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomMaterial2", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    HotelName = table.Column<int>(type: "int", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PlayerRoomId = table.Column<int>(type: "int", nullable: false),
                    RoomMaterialId = table.Column<int>(type: "int", nullable: false),
                    RoomMaterial2Id = table.Column<int>(type: "int", nullable: false),
                    CreatedTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlayerRoomMaterials_RoomMaterial_RoomMaterialId",
                        column: x => x.RoomMaterialId,
                        principalTable: "RoomMaterial",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlayerRoomMaterials_RoomMaterial2_RoomMaterial2Id",
                        column: x => x.RoomMaterial2Id,
                        principalTable: "RoomMaterial2",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "d4a1ee51-c8ea-4d64-9a57-adeb729bc226", "Admin Account", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Description", "Name", "NormalizedName" },
                values: new object[] { 2, "b22aeba7-d276-417b-826d-3bd5293809ab", "User Account", "User", "USER" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Description", "Name", "NormalizedName" },
                values: new object[] { 3, "70b1d462-d291-4033-ae34-ed9e724da893", "ProjectAdmin Account", "ProjectAdmin", "PROJECTADMİN" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlayerRoomMaterials_RoomMaterial2Id",
                table: "PlayerRoomMaterials",
                column: "RoomMaterial2Id");

            migrationBuilder.CreateIndex(
                name: "IX_PlayerRoomMaterials_RoomMaterialId",
                table: "PlayerRoomMaterials",
                column: "RoomMaterialId");
